...
@CucumberOptions(features = {"src/test/resources/uitestingfeaturefiles/UICoaches.feature"},
...
public class CoachTestRunner {
}
// tags = "@Coaches or @Responsive or @bookWorkout", tags="@InvalidDate",
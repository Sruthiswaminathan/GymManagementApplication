Feature: Criteria Management
  ...
  Scenario Outline: Perform fetch the criteria using email
    ...
    Examples:
      ...
      | coach@epam.com | 200    | Retrieved criteria successfully. |
  ...
  Scenario Outline: Successfully update criteria with valid Bearer token
    ...
    Examples:
      ...
      | coach@epam.com | CLIENT | 200    | Criteria updated successfully.                 |
  ...
  Scenario: Successfully remove criteria with valid Bearer token
    Given the user has a valid email "coach@epam.com" to remove and there is "admin89@epam.com" admin exists
    When the user sends a DELETE request to remove criteria with email "coach@epam.com"
